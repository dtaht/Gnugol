...
**** STARTED Pick up the default language from the environment
     :LOGBOOK:
     - State "STARTED"    from "STARTED"    [2010-12-30 Thu 12:46]
     CLOCK: [2010-12-30 Thu 12:46]
     :END:
     :PROPERTIES:
     :Effort:   1:00
     :END:
     Different engines do this differently. Google needs 2 char codes, bing uses the full utf-8 string
